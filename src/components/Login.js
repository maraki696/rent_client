    ...
    <div className="d-flex justify-content-center align-items-center vh-100">
      <div className="card p-4 shadow-lg d-flex flex-row">
        <div className="d-none d-md-block">
          <img src={avatar} alt="Login Avatar" className="img-fluid" style={{ maxWidth: "300px" }} />
        </div>
        ...
        <div className="p-4" style={{ width: "300px" }}>
          ...
          <Link className="mt-3 d-block text-end text-secondary fw-bold text-decoration-none" to={'/management/create_account'}>
            Create New Account?
          </Link>
        </div>
      </div>
